...
class _srsState extends State<srs> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:AppBar(title:Text('SRS Travels',
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Text(
                    "SRS Travels",
                    style: TextStyle(color: Colors.yellow, fontSize: 28.0, fontWeight: FontWeight.bold),
                  ),
                ),
                Row(
                  children: <Widget>[
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text("Started in 1971,we are proud to state that 'SRS Travels' "
                          "has made tremendous progress in its chosen field and currently "
                          "commands a fleet of nearly 5000 vehicles operating on 24/7 basis.\n Visit: www.SRStravels.com", textAlign: TextAlign.justify, style: TextStyle(
