            ...
            return Container(
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: <Widget>[
                    Image.asset('assets/gift/gift2.png',height: 150,),
                    SizedBox(height: 5,),
                    Text('Use Coupon BUS1000: Get Upto RS.1000 Cashback',
                      style: TextStyle(
                    ...
                    Text('Apply coupon code BUS100 at bus checkout and get 100% upto Rs.1000 Promo Cashback.',
                      style: TextStyle(letterSpacing: 0.5),),
                    SizedBox(height: 10.0,),
                    Text('This offer is valid on a minimum transaction value of Rs.5000.',
                      style: TextStyle(letterSpacing: 0.5),),
                    SizedBox(height: 10.0,),
                    Text('Offer is valid only for private bus booking, not on KSRTC.',
                      style: TextStyle(letterSpacing: 0.5),),
                    SizedBox(height: 10.0,),
                    Text('All customers who have applied BUS1000 and successfully completed the transaction will receive the cashback post journey completion.',
                      style: TextStyle(letterSpacing: 0.5),),
                    SizedBox(height: 10.0,),
