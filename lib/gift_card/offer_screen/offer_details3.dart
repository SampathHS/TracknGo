            ...
            return Container(
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: <Widget>[
                    SizedBox(height: 10,),
                    Image.asset('assets/gift/gift4.png',height: 150,),
                    SizedBox(height: 5,),
                    Text('Use Coupon RIDEGOLD: Get 1 GRAM GOLD.',
                      style: TextStyle(
                    ...
                    Text('Apply coupon code RIDEGOLD at bus checkout and get 1 GRAM GOLD and Rs.100 Promo Cashback.',
                      style: TextStyle(letterSpacing: 0.5),),
                    SizedBox(height: 10.0,),
                    Text('This offer is valid on a minimum transaction value of Rs.1500.',
                      style: TextStyle(letterSpacing: 0.5),),
                    SizedBox(height: 10.0,),
